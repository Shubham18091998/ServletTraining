 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://impl.cg.com/", wsdlLocation = "http://localhost:9002/calservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://impl.cg.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9002/calservice?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://impl.cg.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cg.com/", "CalculatorImplPort"), Calculator.class, features);
    }
