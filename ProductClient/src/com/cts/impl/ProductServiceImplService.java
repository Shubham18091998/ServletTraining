 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://impl.cts.com/", wsdlLocation = "http://localhost:9003/prodservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICEIMPLSERVICE_QNAME = new QName("http://impl.cts.com/", "ProductServiceImplService");
    ...
    public ProductService getProductServiceImplPort() {
        return super.getPort(new QName("http://impl.cts.com/", "ProductServiceImplPort"), ProductService.class);
    }
    ...
    public ProductService getProductServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cts.com/", "ProductServiceImplPort"), ProductService.class, features);
    }
